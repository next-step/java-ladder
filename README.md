...
- [x] 유저의 사다리 타기 실행결과를 얻을 수 있어야 한다.
  - [x] 유저들은 사다리의 각자의 위치를 가지고 있다,
  - [x] 사다리 Lines는 유저들의 위치를 이동 시킬 수 있어야 한다.
- [x] 사다리 시뮬레이션 결과를 DTO로 세팅해서 View로 전송한다.
  - [X] 결과를 담고 있는 별도 클래스를 만든다.
