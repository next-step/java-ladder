...
public class LadderGameTest {
    ...
    void ladderGameStartTest(int lineHeight, int playerCount) {
        List<Line> lines = LadderGame.start(lineHeight, playerCount, new PointRandomStrategy());
        assertThat(lines.size()).isEqualTo(lineHeight);
    }
    ...
    void allLadderResultTest(List<Line> lines, List<Player> players, List<Prize> prizes) {
        LadderGame ladderGame = LadderGame.result(players, lines, prizes);

        Map<Player, Prize> results = ladderGame.getResults();
    ...
    void particularPlayerPrize(List<Line> lines, List<Player> players, List<Prize> prizes) {
        LadderGame ladderGame = LadderGame.result(players, lines, prizes);
