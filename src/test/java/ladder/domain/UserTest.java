...
class UserTest {
    ...
    void constructor_when_invalid_name(String name) {
        assertThatThrownBy(() -> new User(name)).isInstanceOf(IllegalArgumentException.class).hasMessage("The maximum length of a name cannot exceed " + MAX_NAME_SIZE + " characters.");
    }
}
