...
public class LineTest {
    ...
    @DisplayName("두 라인의 같은 인덱스 값이 true인 인덱스를 찾을 때")
    @Nested
    class FindIndexesBothTrue {
        ...
        void validate_size() {
            ...
            ThrowingCallable actual = () -> line1.findIndexesBothTrue(line2);
        ...
        void find_indexes() {
            ...
            List<Integer> actual = line1.findIndexesBothTrue(line2);
        ...
        @Test
        void not_match() {
            Line line1 = new Line(List.of(new Stick(true), new Stick(false)));
            Line line2 = new Line(List.of(new Stick(true)));
