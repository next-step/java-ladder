...
public class LineTest {
    ...
    void 라인_생성_성공_테스트() {
        Line line = new Line(new Points(false, true, false, true));
    ...
    void 라인_생성_연속_실패_테스트() {
        assertThatThrownBy(() -> new Line(new Points(false, false, true, true)))
    ...
    @Test
    void 라인_제자리_이동_테스트() {
        Line line = new Line(new Points(false, true, false, false));
