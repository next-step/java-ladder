...
class StickTest {
    ...
    class Create {
        ...
        void create_by_strategy(StickDecisionStrategy stickDecisionStrategy, Stick expected) {
            Stick actual = new Stick(stickDecisionStrategy);
        ...
        private Stream<Arguments> generateStickStrategy() {
            return Stream.of(
                    Arguments.arguments((StickDecisionStrategy) () -> true, new Stick(true)),
                    Arguments.arguments((StickDecisionStrategy) () -> false, new Stick(false))
            );
        }
