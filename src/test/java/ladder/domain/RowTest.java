...
public class RowTest {
    ...
    @Test
    void tooShort() {
        assertThatThrownBy(() -> Row.createManual(Arrays.asList(false))).isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void lengthShouldBeWidthPlusOne() {
        Row manualRow = Row.createManual(Arrays.asList(false, true, false));
        assertThat(manualRow.size()).isEqualTo(4);
