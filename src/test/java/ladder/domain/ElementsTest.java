...
class ElementsTest {
    ...
    void invalidCount() {
        assertThatThrownBy(() -> Elements.createPlayers(new String[]{"tom"}))
    ...
    void totalPoint() {
        assertThat(Elements.createPlayers(new String[]{"tom", "tommy", "paul"}).pointCount()).isEqualTo(2);
        assertThat(Elements.createResults(new String[]{"tom", "tommy", "paul"}).pointCount()).isEqualTo(2);
    }

    @Test
    @DisplayName("이름들의 크기 중 가장 큰 크기의 값을 반환한다.")
    void maxNameSize() {
        assertThat(Elements.createPlayers(new String[]{"tom", "tommy", "paul"}).maxNameSize()).isEqualTo(5);
        assertThat(Elements.createResults(new String[]{"tom", "tommy", "paul"}).maxNameSize()).isEqualTo(5);
        assertThat(Elements.createPlayers(new String[]{"tom", "안녕하세요", "paul"}).maxNameSize()).isEqualTo(10);
        assertThat(Elements.createResults(new String[]{"tom", "안녕하세요", "paul"}).maxNameSize()).isEqualTo(10);
    }
