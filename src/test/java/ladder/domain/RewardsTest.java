...
public class RewardsTest {
    ...
    void create() {
        Rewards rewards = new Rewards(List.of("꽝", "3000", "꽝", "3000"), 5);
        Rewards equalExpected = new Rewards(List.of("꽝", "3000", "꽝", "3000"), 5);
        Rewards notEqualExpected = new Rewards(List.of("3000", "5000", "꽝", "3000"), 5);
    ...
    void results_성공() {
        Rewards rewards = new Rewards(List.of("꽝", "3000", "2000", "1000"), 5);
