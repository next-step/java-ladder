...
public class PrizesTest {
    ...
    void 입력된_각_사다리의_결과들로_Results를_생성한다() {
        ...
        Prizes prizes = Prizes.from(inputPrizes, numberOfPlayers);

        assertThat(prizes.getPrizes().size()).isEqualTo(numberOfPlayers);
    }
    ...
    void 플레이어_수와_결과의_수가_같지_않으면_예외가_발생한다() {
        ...
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> {
                    Prizes.from(inputResults, numberOfPlayers);
