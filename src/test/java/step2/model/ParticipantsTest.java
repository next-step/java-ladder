...
public class ParticipantsTest {
    ...
    void create_Participants_For_Ladder_Game(String[] names, int expected) {
        assertThat(Participants.of(Arrays.asList(names)).getNumberOfParticipants()).isEqualTo(expected);
    }
    ...
    void create_Participants_For_Ladder_Game_And_Finding_Name(String[] names, String Condition, String expected) {
        assertThat(Participants.of(Arrays.asList(names)).findPersonByName(Condition).printName()).isEqualTo(expected);
    }
    ...
    void create_Participants_For_Ladder_Game_And_Check_ToString(String[] names, String expected) {
        assertThat(Participants.of(Arrays.asList(names)).toString()).isEqualTo(expected);
    }
}
