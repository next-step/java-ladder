...
class LadderTest {
    ...
    void throwLadderHeightException() {
        assertThatThrownBy(() -> Ladder.of(0, 1, new NotCreateLadderPointGenerator()))
    ...
    void throwPlayerRewardsCountException() {
        assertThatThrownBy(() -> Ladder.of(1, 0, new NotCreateLadderPointGenerator()))
    ...
    void create() {
        Ladder ladder = Ladder.of(3, 3, new NotCreateLadderPointGenerator());

        assertThat(ladder).usingRecursiveComparison()
                .isEqualTo(Ladder.of(3, 3, new NotCreateLadderPointGenerator()));
    }
