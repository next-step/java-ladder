...
class LadderTest {
    ...
    void 사다리는_최소_1이상의_높이를_가져야_한다() {
        assertThatThrownBy(() -> Ladder.of(List.of("pobi", "honux"), new Lines(List.of())))
    ...
    void 사다리_게임은_2명_미만의_참가자로는_생성할_수_없다() {
        assertThatThrownBy(() -> Ladder.of(List.of("pobi"), new Lines(List.of(Line.from(1)))))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void 사다리_게임은_2명_이상의_참가자로_생성할_수_있다() {
        assertThatCode(() -> Ladder.of(List.of("pobi", "crong"), new Lines(List.of(Line.from(2)))))
