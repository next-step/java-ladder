...
public class LadderTest {
    ...
    static Stream<Arguments> parseInvalidLadder() {
        return Stream.of(
                ...
                Arguments.of(ptc(5), null, NO_LINE_STRATEGY),
    ...
    public void createFailed(PointCount pointCount, Height height, LadderPointGenerateStrategy strategy) {
    ...
    static Stream<Arguments> parseLadderResult() {
        return Stream.of(
                Arguments.of(Ladder.of(1, 2, NO_LINE_STRATEGY),
                        lf(List.of("p1", "p2"), List.of("r1", "r2")),
                        ResultOfGame.of(Map.of(p("p1"), r("r1"), p("p2"), r("r2")))),
                Arguments.of(Ladder.of(1, 1, ALL_LINE_STRATEGY),
                        lf(List.of("p1", "p2"), List.of("r1", "r2")),
                        ResultOfGame.of(Map.of(p("p1"), r("r2"), p("p2"), r("r1")))),
                Arguments.of(Ladder.of(1, 2, ALL_LINE_STRATEGY),
                        lf(List.of("p1", "p2"), List.of("r1", "r2")),
                        ResultOfGame.of(Map.of(p("p1"), r("r1"), p("p2"), r("r2"))))
        );
    }
    ...
    static Stream<Arguments> parseLadderDownToResult() {
        return Stream.of(
                Arguments.of(pc(2), h(1), NO_LINE_STRATEGY,
                        List.of(0, 1)),
                Arguments.of(pc(2), h(1), ALL_LINE_STRATEGY,
                        List.of(1, 0)),
                Arguments.of(pc(2), h(2), ALL_LINE_STRATEGY,
                        List.of(0, 1))
        );
    }
    ...
    public void downToResult(PlayerCount pc, Height height, LadderPointGenerateStrategy strategy, List<Integer> expected) {
