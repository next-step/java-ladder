...
class LadderGameInitInfoTest {
    ...
    @Test
    void init() {
        assertThat(LadderGameInitInfo.of(TWO_PLAYERS_AND_GIFTS, LADDER_INIT_INFO_2_X_2_TEMP)).isInstanceOf(LadderGameInitInfo.class);
    }
    ...
    private static Stream<Arguments> initException() {
        return Stream.of(
                Arguments.of(null, LADDER_INIT_INFO_2_X_2_TEMP),
