...
public class PlayerTest {
    ...
    void names() {
        // given
        String name = "홍길동";
        Player player = new Player(name, Position.get(1));
    ...
    void isEqualWith() {
        ...
        String name = "홍길동";
        Player player = new Player(name, Position.get(1));
        Position target = Position.get(1);
    ...
    void isEqualName() {
        // given
        Player player = new Player("홍길동", Position.get(1));
    ...
    void move() {
        ...
        // then
        assertThat(movedPlayer.isEqualCoordinate(Position.get(0))).isTrue();
    }
}
