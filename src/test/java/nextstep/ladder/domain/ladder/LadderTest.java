...
public class LadderTest {
    ...
    void exception() {
        List<Position> positions = Arrays.asList(new Position(0, Height.of(0), new Line(true, Direction.of(Direction.RIGHT))));
    ...
    private static Stream<Arguments> 사다리_위치_리스트_생성() {
        ...
        positions.add(new Position(0, Height.of(0), new Line(true, Direction.of(Direction.RIGHT))));
        positions.add(new Position(1, Height.of(0), new Line(true, Direction.of(Direction.LEFT))));
