...
class LadderCreatorImplTest {

    private final RandomValueGenerator trueGenerator = () -> true;
    private final LadderLineCreator ladderLineCreator = new LadderLineCreatorImpl(trueGenerator);
    private final LadderCreator target = new LadderCreatorImpl(ladderLineCreator);
