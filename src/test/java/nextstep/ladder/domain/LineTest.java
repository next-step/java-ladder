...
class LineTest {
    ...
    @Test
    void n개_create() {
        assertThat(new Line(3, () -> true).getPoints()).isEqualTo(Arrays.asList(false, true, false));
        assertThat(new Line(3, () -> false).getPoints()).isEqualTo(Arrays.asList(false, false, false));
    }
}