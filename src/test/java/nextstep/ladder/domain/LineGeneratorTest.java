...
class LineGeneratorTest {
    ...
    void create() {
        ...
        assertThat(LineGenerator.generate(list)).isInstanceOf(Line.class);
    }
    ...
    void size() {
        List<Boolean> list = Arrays.asList(Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE);
        Line line = LineGenerator.generate(list);
    ...
    void exception(List<Boolean> list) {
        assertThatThrownBy(() -> LineGenerator.generate(list)).isInstanceOf(LineRowException.class);
    }
}