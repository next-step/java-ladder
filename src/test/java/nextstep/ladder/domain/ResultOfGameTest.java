...
public class ResultOfGameTest {
    @Test
    public void create() {
        Map<PlayerName, Prize> resultMap = Map.of(pn("p1"), pz("r1"), pn("p2"), pz("r2"));
    ...
    public void createFailed(Map<PlayerName, Prize> playerResultMap) {
    ...
    public void resultExist() {
        PlayerName p1 = pn("p1");
        Prize r1 = pz("r1");
        Map<PlayerName, Prize> resultMap = Map.of(p1, r1, pn("p2"), pz("r2"));
