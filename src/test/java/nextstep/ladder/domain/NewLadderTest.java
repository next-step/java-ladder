...
class NewLadderTest {
  ...
  @Test
  void init() {
    NewLadder ladder = NewLadder.init(new Length(10), new Length(20));
    assertAll(
  ...
  @Test
  void init_invalid() {
    assertThatThrownBy(() -> NewLadder.init(new Length(0), new Length(0)))
...
*/
  ...
  @Test
  void move() {
    NewLadder ladder = new NewLadder(List.of(
  ...
  void move_invalid(int invalidIndex) {
    NewLadder ladder = NewLadder.init(new Length(4), new Length(3));
