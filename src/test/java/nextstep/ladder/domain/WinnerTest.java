...
public class WinnerTest {
    ...
    void testWinnerCreation() {
        assertEquals(PERSON_IMPL, WINNER_IMPL.getPerson());
        assertEquals(RESULT, WINNER_IMPL.getResult());
        assertEquals("hoya", WINNER_IMPL.getName());
    }
