...
public class LambdaTest {
    ...
    public void sumAll() throws Exception {
        int sum = Lambda.sumWithConditional(numbers, (number)->{ return true; });
        assertThat(sum).isEqualTo(21);
    }

    @Test
    public void sumAllEven() throws Exception {
        int sum = Lambda.sumWithConditional(numbers, (number)->{ return number % 2 == 0; });
        assertThat(sum).isEqualTo(12);
    }

    @Test
    public void sumAllOverThree() throws Exception {
        int sum = Lambda.sumWithConditional(numbers, (number)->{ return number > 3; });
