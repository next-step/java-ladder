...
public class LambdaTest {
    ...
    @Test
    public void sumAllWithCondition() throws Exception {
        int sum = Lambda.sumAll(numbers, number -> true);
        assertThat(sum).isEqualTo(21);
    }

    @Test
    public void sumAllEvenWithCondition() throws Exception {
        int sum = Lambda.sumAll(numbers, number -> number % 2 == 0);
        assertThat(sum).isEqualTo(12);
    }

    @Test
    public void sumAllOverThreeWithCondition() throws Exception {
