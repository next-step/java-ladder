...
public class LambdaTest {
    ...
    @Test
    public void sumAllByPredicate() {
        int sumAll = Lambda.sumAllByPredicate(numbers, (number) -> true);
        assertThat(sumAll).isEqualTo(21);

        int sumAllEven = Lambda.sumAllByPredicate(numbers, (number) -> number % 2 == 0);
        assertThat(sumAllEven).isEqualTo(12);

        int sumAllOverThree = Lambda.sumAllByPredicate(numbers, (number) -> number > 3);
