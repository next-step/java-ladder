...
class PrizesTest {
	...
	private final Prizes prizes = Prizes.from("꽝,1000,5000,10000");
	...
	@DisplayName("사다리 게임의 모든 결과 값들을 리스트로 반환한다.")
	@Test
	void values() {
		assertThat(prizes.values()).containsExactly("꽝", "1000", "5000", "10000");
	}
