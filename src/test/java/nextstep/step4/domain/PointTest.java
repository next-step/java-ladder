...
class PointTest {
    ...
    void setFirstFalse() {
        Point point = Point.setFirst(true);
    ...
    @DisplayName("왼쪽 이동")
    void setNextFalse() {
        Point point = Point.setFirst(true).setNext(false);
    ...
    @DisplayName("오른쪽 이동")
    void moveRight() {
        Point point = Point.setFirst(false).setNext(true);
        assertThat(point.move()).isEqualTo(Direction.RIGHT);
    }
    ...
    @DisplayName("직진 이동")
    void moveForward() {
        Point point = Point.setFirst(false).setNext(false);
    ...
    void setLast() {
        Point point = Point.setFirst(true).setNext(false).last();
        assertThat(point.move()).isEqualTo(Direction.FORWARD);
    }
    ...
    void doubleTrueException() {
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> Point.setFirst(true).setNext(true));
    }
