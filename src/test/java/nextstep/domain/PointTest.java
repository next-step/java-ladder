...
public class PointTest {
    ...
    void init() {
        ...
        assertThat(point.move().moveDirections()).isEqualTo(RIGHT);
    }

    @Test
    void insert_false_when_left_is_true() {
        Point point = Point.init(true).insert(false);
        assertThat(point.move().moveDirections()).isEqualTo(LEFT);
    }
    ...
    void insert_false_when_left_is_false() {
        ...
        assertThat(point.move().moveDirections()).isEqualTo(PASS);
    }
