...
class AwardsTest {
    ...
    @Test
    void create() {
        assertThat(new Awards(Arrays.asList("qwe", "asd", "zxc", "sdf"), 4)).isInstanceOf(Awards.class);
    }
    ...
    void validate_참가자와_결과의_갯수가_다를_경우_에러발생() {
        assertThatIllegalArgumentException().isThrownBy(() -> {
            new Awards(Arrays.asList("qwe", "asd", "zxc"), 4);
    ...
    void findIndex(String name, int index) {
        Awards awards = new Awards(Arrays.asList("fail", "2000", "fail", "3000"), 4);
