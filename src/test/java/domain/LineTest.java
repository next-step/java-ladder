...
public class LineTest {
    ...
    public void 전달한_길이의_라인을_생성한다() {
        Line line = Line.newLine(new ArrayList<>(Arrays.asList(
    ...
    public void 길이_2_미만의_라인은_생성할수_없다() {
        Line.newLine(Arrays.asList(Boolean.TRUE));
    }

    @Test
    public void 전달한_위치에서_이동한_위치를_반환한다() {
        Line line1 = Line.newLine(new ArrayList<>(Arrays.asList(
            Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE)));
        assertThat(line1.move(1)).isEqualTo(2);
        assertThat(line1.move(3)).isEqualTo(4);

        Line line2 = Line.newLine(new ArrayList<>(Arrays.asList(
