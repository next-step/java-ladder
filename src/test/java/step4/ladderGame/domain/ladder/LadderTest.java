...
class LadderTest {
    ...
    @Test
    void create() {
        assertThat(new Ladder(5, 5, new GenerateRandomDirectionStrategy())).isInstanceOf(Ladder.class);
    }
    ...
    void validate_참가자가_두명_미만일_경우_에러() {
        assertThatIllegalArgumentException().isThrownBy(() -> {
            new Ladder(1, 5, new GenerateRandomDirectionStrategy());
    ...
    void validate_사다리_높이가_1미만일_경우_에러() {
        assertThatIllegalArgumentException().isThrownBy(() -> {
            new Ladder(5, 0, new GenerateRandomDirectionStrategy());
    ...
    @Test
    void move() {
        Ladder ladder = new Ladder(5, 5, new GenerateRandomDirectionStrategy());
