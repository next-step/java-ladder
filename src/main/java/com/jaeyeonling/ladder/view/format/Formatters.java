...
public final class Formatters {
    ...
    public static final Formatter<LadderGame> ladderGameFormatter = LadderGameFormatter.withLinesFormatter(linesFormatter);

    public static final Formatter<LadderResults> ladderResultsFormatter = new LadderResultsFormatter();
