...
public class LadderResultView {
    ...
    public static void printLadderResultPhrase() {
        System.out.println(NEW_LINE + LADDER_RESULT_PHRASE);
    }

    public static void printUserNames(String userNameStatus) {
        System.out.print(NEW_LINE);
        System.out.println(userNameStatus);
    }

    public static void printLadderLines(String ladderLinesStatus) {
        System.out.println(ladderLinesStatus);
    }

    public static void printRewards(String rewardStatus) {
        System.out.println(rewardStatus);
        System.out.print(NEW_LINE);
    }

    public static void printSimulateResult(Map<String, String> resultMap) {
