...
public class Person {
    ...
    private static final String PERSON_MINIMUM_COUNT_ERROR = "최소 2명 이상 참가해야합니다.";
    private static final String NAME_MAX_LENGTH_ERROR = "사람 이름은 최대 5글자 입니다.";
    private static final int PERSON_MINIMUM_COUNT = 2;
    ...
    private void validPersonSizeTwoUnder(int length) {
        if (length < PERSON_MINIMUM_COUNT) {
            throw new IllegalArgumentException(PERSON_MINIMUM_COUNT_ERROR);
        }
    }
