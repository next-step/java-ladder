...
public class LadderLineOld {

    private final List<LadderBridge> bridges;

    private LadderLineOld(final List<LadderBridge> bridges) {
        validate(bridges);
    ...
    public static LadderLineOld newInstance(final LadderBridge... bridges) {
        return new LadderLineOld(Arrays.asList(bridges));
    }

    public static LadderLineOld newInstance(final int poleCount) {
        return newInstance(PoleCount.of(poleCount));
    }

    public static LadderLineOld newInstance(final PoleCount poleCount) {
        ...
        return new LadderLineOld(bridges);
    }
