...
public class LadderGameApp {
    ...
    public static void main(String[] args) {
        try {
            ...
            LadderGame game = new LadderGame(height, players, results);
            ResultView.printLadderResult(players, game.getLadder(), results);
            ResultView.printResult(game.play(), InputView.getStringValue("결과를 보고 싶은 사람은?"));
        } catch (Exception ex) {
