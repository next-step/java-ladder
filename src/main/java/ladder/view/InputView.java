...
public class InputView {
    private static final String PARTICIPANT_QUESTION = "참여할 사람 이름을 입력하세요. (이름은 쉼표(,)로 구분하세요)";
    private static final String LADDER_COUNT_QUESTION = "최대 사다리 높이는 몇 개인가요?";
    private static final String LADDER_RESULT_QUESTION = "실행 결과를 입력하세요. (결과는 쉼표(,)로 구분하세요)";
    private static final String RESULT_PERSON_SENTENCE = "결과를 보고 싶은 사람은?";
