...
public class InputView {
    ...
    private static final String INPUT_COMPLEXITY_MENT = "실행할 사다리의 난이도는?";
    ...
    public static String inputComplexity(Scanner scanner) {
        try {
            System.out.println(INPUT_COMPLEXITY_MENT);
