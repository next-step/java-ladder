...
public class Messages {
    public static final String MESSAGE_INPUT_PLAYERS = "참여할 사람의 이름을 입력하세요. 단, 이름은 쉼표(,)로 구분";
    public static final String MESSAGE_INPUT_LADDER_HEIGHT = "최대 사다리 높이는 몇 개인가요?";
    public static final String MESSAGE_INPUT_LADDER_RESULT = "실행결과를 입력하세요. 단, 결과는 쉼표(,)로 구분";
    public static final String MESSAGE_INPUT_PLAYER_TO_KNOW_RESULT = "결과를 보고 싶은 사람은?";
    ...
    public static final String WARNING_NOT_ALLOWED_NUMBER = "양수만 입력 가능합니다.";
}
