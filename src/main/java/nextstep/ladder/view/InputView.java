...
public final class InputView {
    ...
    private static final String EXECUTION_RESULTS_INPUT_MESSAGE = "\n실행 결과를 입력하세요. (결과는 쉼표(,)로 구분하세요)";
    ...
    public static List<String> readExecutionResults() {
        System.out.println(EXECUTION_RESULTS_INPUT_MESSAGE);
