...
public class ResultView2 {
    ...
    private static ResultView2 resultView = new ResultView2();

    public static ResultView2 getResultView() {
        return resultView;
    }
    ...
    public String drawLadder(GameInfo gameInfo, Ladder2 ladder) {
    ...
    public void printLadder(GameInfo gameInfo, Ladder2 ladder) {
        System.out.println("\n사다리 결과\n");
    ...
    private String appendLines(Ladder2 ladder) {
