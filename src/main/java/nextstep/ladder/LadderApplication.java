...
import nextstep.ladder.controller.UserResultsRequest;
...
public class LadderApplication {
    public static void main(String[] args) {
        ...
        UserResults userResults = controller.retrieveUserResults(RetrieveResultRequest.of(ladder, UserResultsRequest.of(users, ladderResults)));
        OutputView.printExecutionResultForUsers(userResults, InputView.readCommandForResultOfTargetUser());
    }
}
