package nextstep.ladder.constant;
...
public class LadderConstants {
    ...
    public static final String EXECUTION_LADDER_RESULT_MESSAGE = "사다리 결과";
    public static final String SHAPE_OF_HEIGHT = "|";
    public static final String SHAPE_OF_MOUNTING_BLOCK = "-----";
    public static final String BLANK_MOUNTING_BLOCK = "     ";
    public static final Integer FIRST_HEIGHT_PADDING_VALUE = 6;
    ...
    public static final String INVALID_USER_NAME_IN_EXECUTION_RESULTS = "입력하신 사용자는 없는 사용자입니다.";
    public static final String WHAT_YOU_WANT_TO_SEE_PLAYER_EXECUTION_RESULT = "결과를 보고싶은 사람은?";
}
