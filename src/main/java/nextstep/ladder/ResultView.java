...
public class ResultView {
    ...
    public static void printResult(String resultUserName, Usernames usernames, Ladder ladder2, List<String> results) {
    ...
    private static Map<String, String> allResult(Usernames usernames, Ladder ladder2, List<String> results) {
