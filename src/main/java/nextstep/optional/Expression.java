...
enum Expression {
    ...
    private static final String PRINT_INVALID_EXPRESSION = "%s는 사칙연산에 해당하지 않는 표현식입니다.";
    ...
    static Expression of(String expression) {
        return Arrays.stream(Expression.values())
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException(String.format(PRINT_INVALID_EXPRESSION, expression)));
    }
}
