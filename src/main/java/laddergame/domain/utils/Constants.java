...
public class Constants {
    ...
    public static String INPUT_GAME_RESULTS = "실행 결과를 입력하세요. (결과는 쉼표(,)로 구분하세요)";
    public static String INPUT_MAX_LADDER_HEIGHT = "최대 사다리 높이는 몇 개인가요?";
    public static String PLAYER_NAME_SEPERATOR = ",";
    public static String GAME_RESULT_SEPERATOR = ",";
    public static String ALL_PLAYER = "all";

    // result
    public static String LADDER_RESULT = "사다리 결과";
    public static String GAME_PRIZE = "실행 결과";
