...
public class InputView {
    ...
    public static LadderResult getResultsFromUser(int playerCount){
        String resultInput = getGameResultInput();
        List<String> results = getResults(resultInput, playerCount);
    ...
    private static List<String> getResults(String gameResult, int playerCount) {
