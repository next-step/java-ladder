...
public class InputView {
    ...
    private static final String INPUT_REWARD_RESULT_NAME_MESSAGE = "결과를 보고 싶은 사람은?";
    ...
    public static String inputRewardResultName() {
        System.out.println(INPUT_REWARD_RESULT_NAME_MESSAGE);
        return scanner.nextLine();
    }
}
